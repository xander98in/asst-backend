 ...
 *
 * <p>Contiene información demográfica y laboral relevante para la evaluación de riesgo psicosocial.</p>
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
...
public class PersonEvaluatedDetailsCreateRequestDTO {
    ...
    /**
     * ID del registro de gestión de baterías al que se asociarán estos detalles.
     */
